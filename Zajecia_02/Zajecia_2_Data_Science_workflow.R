...
# 2) WYKORZYSTANIE PACZKI DPLYR ----

library(dplyr)

# 1. mutate() – tworzenie nowych zmiennych na bazie istniejących ----
...
# 6. summarise() - obliczanie wartości zagregowanych (np. średnich, sum) ----
